...
| <a name="input_pre_created_aws_cloud_cluster_nodes_sg_id"></a> [pre_created_aws_cloud_cluster_nodes_sg_id](#input_pre_created_aws_cloud_cluster_nodes_sg_id)                         | The ID of the pre-created security group to use for the Rubrik Cloud Cluster nodes.                                                                                                          | `string`       | `""`                                      |    no    |
...
| <a name="output_rubrik_nodes_sg_id"></a> [rubrik_nodes_sg_id](#output_rubrik_nodes_sg_id)                                                    | The security group ID used for Rubrik Cloud Cluster nodes (either pre-created or module-created)                           |
